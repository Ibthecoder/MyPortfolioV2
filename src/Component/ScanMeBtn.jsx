...
const ScanMeBtn = () => {
  return (
    // <div className="grid min-h-[200px] place-content-center b p-4">
    //   <EncryptButton />
    // </div>
    <div className="items-start p-4">
      {" "}
      <EncryptButton /> {/* Your button component */}
    </div>
  );
};
    ...
    <motion.button
      ...
      onClick={() =>
        (window.location.href =
          "mailto:oladipupoibrahim10@gmail.com?subject=Have a Project? Let’s Talk!")
      }
    >
